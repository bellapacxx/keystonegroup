  ...
  return (
    <footer className="bg-brand-900 text-neutral-100 py-12 mt-12 border-t border-brand-700">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
        {/* Company Info */}
        <div>
          <h3 className="text-mint-500 font-bold text-lg mb-2">
            Keystone Group
          </h3>
          <p>Unlocking The Potential</p>
          <p className="mt-2 text-sm">
            © {new Date().getFullYear()} Keystone Group Investment
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1">
            {["Home", "About", "Subsidiaries", "Strategy", "Contact"].map(
              (link) => (
                <li key={link}>
                  <a
